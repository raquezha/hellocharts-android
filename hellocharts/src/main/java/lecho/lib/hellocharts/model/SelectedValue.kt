...
class SelectedValue {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val otherObj = other as SelectedValue
        if (firstIndex != otherObj.firstIndex) return false
        return if (secondIndex != otherObj.secondIndex) false else type == otherObj.type
    }
